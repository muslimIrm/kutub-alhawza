            ...
            <div className="container ">
                <div className="flex flex-col w-full justify-center items-center text-center !gap-7">
                    <div className='absolute top-0 left-1/2 -translate-x-1/2 flex !gap-3 !px-4 !py-3 bg-white rounded-br-2xl rounded-bl-2xl'>
                        ...
                        <a
                            href="https://wa.me/009647863756645"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                        ...
                        <a
                            href="https://www.instagram.com/ms0h_0"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                    ...
                    <p className="text-lg text-neutral-600 max-w-1/2 max-md:max-w-full">
                        مرحبًا بك في مكتبة الحوزة العلمية، حيث نجمع كل كتب الحوزة في مكان واحد لتسهيل البحث والدراسة على طلاب العلم. اكتشف الكتب والمراجع المنظمة بعناية لتجد ما تحتاجه بسرعة وسهولة. صُممت مكتبة الحوزة العلمية لتكون بوابتك لعالم علوم أهل البيت عليهم السلام، لتجعل رحلتك العلمية أكثر إثراءً وسلاسة.
